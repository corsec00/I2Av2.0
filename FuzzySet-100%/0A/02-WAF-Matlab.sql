...
UPDATE [28].[dbo].[Full] SET Metodo ='5' WHERE Metodo like 'MKCOL';
go

UPDATE [28].[dbo].[Full] SET ACAO ='0' WHERE ACAO LIKE 'ACCEPT%';
UPDATE [28].[dbo].[Full] SET ACAO ='1' WHERE ACAO LIKE 'DROP';
UPDATE [28].[dbo].[Full] SET ACAO ='2' WHERE ACAO LIKE 'KEY%';
UPDATE [28].[dbo].[Full] SET ACAO ='3' WHERE ACAO is NULL;
...
UPDATE [28].[dbo].[Full] SET UserAgentBrowser ='8' WHERE UserAgentBrowser is NULL;
UPDATE [28].[dbo].[Full] SET Servico ='7' WHERE Servico is NULL;
UPDATE [28].[dbo].[Full] SET Informacao ='0' WHERE Informacao is NULL;
UPDATE [28].[dbo].[Full] SET Produto ='0' WHERE Produto is NULL;
